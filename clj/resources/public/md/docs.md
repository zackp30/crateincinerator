...
Two middleware functions are provided by default in the `crateincinerator.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `crateincinerator.handler` namespace to manage the enabled middleware.
