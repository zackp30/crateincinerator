...
(function($opal) {
  ...
  $opal.add_stubs(['$ready?', '$find', '$on', '$hide', '$==', '$show', '$animate']);
  ;
  ;
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2, a = nil, b = nil, menu = nil;
  a = 0;
    b = 0;
    menu = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".menu");
    return ($a = ($b = menu).$on, $a._p = (TMP_2 = function(){var self = TMP_2._s || this, $a, text = nil, buttons = nil, menu_thingy = nil, menu_boxes = nil;
    text = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find(".pls");
      ...
      if (b['$=='](0)) {
        buttons.$show("slow");
        (($a = $scope.Document) == null ? $opal.cm('Document') : $a).$find(menu_boxes).$animate($hash2(["height", "width"], {"height": "80%", "width": "80%"}));
        menu_thingy.$hide("fast");
        menu_boxes.$show("fast");
        menu.$animate($hash2(["height", "width", "backgroundColor", "speed"], {"height": 40, "width": 600, "backgroundColor": "orange", "speed": 1600}));
        return b = 1;
        } else {
        menu.$animate($hash2(["height", "width", "backgroundColor", "speed"], {"height": 20, "width": 50, "backgroundColor": "lightblue", "speed": 1600}));
        buttons.$hide("slow");
        menu_thingy.$show("slow");
        menu_boxes.$hide("fast");
        return b = 0;
      };}, TMP_2._s = self, TMP_2), $a).call($b, "click");}, TMP_1._s = self, TMP_1), $a).call($b);
})(Opal);
